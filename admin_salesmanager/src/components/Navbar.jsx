  ...
  return (
    <nav className="flex items-center justify-between p-4 bg-gray-900 text-white shadow-xl relative">
      ...
      >
        ...
        {/* Reorder your links so Home is first */}
        <div className="flex flex-col space-y-4 p-4">
          <Link to="/home" className="flex items-center gap-2 hover:text-blue-300" onClick={handleMenuToggle}>
          ...
          <Link to="/revenues" className="flex items-center gap-2 hover:text-blue-300" onClick={handleMenuToggle}>
            <AiOutlineDashboard className="w-5 h-5" />
            Revenues
          </Link>
